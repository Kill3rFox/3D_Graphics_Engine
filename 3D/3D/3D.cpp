...
private:
    ...
    /*Old code just for note reference
    ...
    //Vector add function - creates a new vector from two vectors input
    ...
    //Test and returns point where a line intersects a plane
    ...
    //Clipping function
    /*How it works: Returns an integer which is how many triangles the function will return 
                    Plane and triangle we want to clip info is provided
                    */
    int Triangle_ClipAgainstPlane(vec3d plane_p, vec3d plane_n, triangle& in_tri, triangle& out_tri1, triangle& out_tri2)
    {
        /*This stuff is wild hurting my head*/
    ...
    public:
        bool OnUserCreate() override
        {
            ...
            //meshCube.tris =
            //{
                /* Old spinning cube code, again for future reference
        ...
        bool OnUserUpdate(float fElapsedTime) override
        {
            ...
            if (GetKey(VK_UP).bHeld)
                vCamera.y += 8.0f * fElapsedTime;	// Y-Axis
            ...
            vec3d vTarget = { 0,0,1 };
          /*Notes overview
            Take a target vector fixed on the z-axis, rotate by Yaw radians so it simulates turning the player, from this comes a new forward vector,
            Which is then added to the camera location so there is a target to look at.*/
            ...
            for (auto tri : meshCube.tris)
            {
                ...
                for (auto& triToRaster : vecTrianglesToRaster)
                {
                    ...
                    /*FillTriangle(triProjected.p[0].x, triProjected.p[0].y,
                        ...
                        triProjected.sym, triProjected.col);    Old code*/

                // Clip triangles against all four screen edges, this could yield a bunch of triangles, so create a queue that we traverse to 
